module Prima.PyxisV2.Form exposing
...
import Prima.PyxisV2.DatePicker as DatePicker
import Prima.PyxisV2.Form.Event as Events exposing (Event)
import Prima.PyxisV2.Form.Validation as FormValidation
import Prima.PyxisV2.Helpers as Helpers exposing (renderIf)
import Prima.PyxisV2.Tooltip as Tooltip
...
{-| Adds a FormField to the form.
    ...
    --
    import Prima.PyxisV2.Form as Form
    import Prima.PyxisV2.Form.Event as Event
    import Prima.PyxisV2.Form.Validation as FormValidation
...
This field can handle only onInput, onFocus, onBlur events. Other events will be ignored.
    ...
    --
    import Prima.PyxisV2.Form as Form exposing (FormField)
    import Prima.PyxisV2.Form.Event as Event
    import Prima.PyxisV2.Form.Validation as FormValidation
...
This field can handle only onSelect event. Other events will be ignored.
    ...
    --
    import Prima.PyxisV2.Form as Form exposing (FormField, RadioOption)
    import Prima.PyxisV2.Form.Event as Event
...
This field can handle only onCheck event. Other events will be ignored.
    ...
    --
    import Prima.PyxisV2.Form as Form exposing (FormField, Label, Slug, CheckboxOption)
    import Prima.PyxisV2.Form.Event as Event
    import Prima.PyxisV2.Form.Validation as FormValidation
...
This field can handle only onToggle, onInput, onSelect, onFocus and onBlur events. Other events will be ignored.
    ...
    --
    import Prima.PyxisV2.Form as Form exposing (FormField, Label, Slug, SelectOption)
    import Prima.PyxisV2.Form.Event as Event
    import Html.Attributes
    ...
...
{-| Renders a single `FormField`
    ...
    import Prima.PyxisV2.Form as Form exposing (Form, FormField)
