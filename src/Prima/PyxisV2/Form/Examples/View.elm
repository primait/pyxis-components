module Prima.PyxisV2.Form.Examples.View exposing (view)
...
import Prima.PyxisV2.Form.Examples.FormConfig as Config
import Prima.PyxisV2.Form.Examples.Model exposing (FormData, Model, Msg(..))
