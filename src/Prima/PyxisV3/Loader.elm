module Prima.PyxisV3.Loader exposing
    ( Config
    , spinner, vehicle
    , render
...
render (Config { size, type_, text }) =
    div
        [ HA.classList
            [ ( "loader", True )
            , ( "loader--small", isLoaderSmall size )
            , ( "loader--medium", isLoaderMedium size )
            ]
        ]
        [ case type_ of
            Spinner ->
...
renderVehicle =
    Svg.svg
        [ SA.width "150"
        , SA.height "50"
        , SA.class "loader__car"
        ]
        [ Svg.g
            [ SA.class "loader__car__group"
            ]
            [ Svg.path
                [ SA.class "loader__car__group__wheel"
                ...
                []
            , Svg.path
                [ SA.class "loader__car__group__body"
            ...
            , Svg.path
                ...
                []
            , Svg.line
                [ SA.class "loader__car__group__line loader__car__group__line--top"
                , SA.x1 "68"
                , SA.y1 "46.7"
                , SA.x2 "114.2"
                , SA.y2 "46.7"
                ...
                []
            , Svg.line
                [ SA.class "loader__car__group__line loader__car__group__line--bottom"
                , SA.x1 "33.2"
                , SA.y1 "65.9"
                , SA.x2 "99.4"
                , SA.y2 "65.9"
                ...
                []
            , Svg.line
                [ SA.class "loader__car__group__line loader__car__group__line--middle"
                , SA.x1 "68"
                , SA.y1 "84.5"
                , SA.x2 "114.2"
                , SA.y2 "84.5"
...
renderText content =
    Html.div
        [ HA.class "loader__text fs-small fw-heavy c-text-dark" ]
        [ Html.p
            []
            [ Html.text content ]
        ]
