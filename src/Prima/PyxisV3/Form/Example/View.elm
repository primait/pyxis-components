module Prima.PyxisV3.Form.Example.View exposing (view)
...
import Prima.PyxisV3.Form.Example.FieldConfig as Config
import Prima.PyxisV3.Form.Example.Model exposing (FormData, Model, Msg(..))
