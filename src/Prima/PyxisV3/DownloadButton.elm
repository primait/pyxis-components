module Prima.PyxisV3.DownloadButton exposing
    ( Config
    , download
    , render
...
import Prima.PyxisV3.DownloadButton.Icons as DownloadIcon
...
{-| Renders the button by receiving it's configuration.
    ...
    import Prima.PyxisV3.DownloadButton as DownloadButtonButton
