module Prima.PyxisV3.Modal.Examples.View exposing
    ( appBody
    , view
    )
...
import Prima.PyxisV3.ButtonGroup as ButtonGroup
...
import Prima.PyxisV3.Modal.Examples.Model exposing (Modal(..), Model, Msg(..))
